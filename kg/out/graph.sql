...
INSERT INTO bundle_meta VALUES ('input_digest_combined', '5483910844151762790');
INSERT INTO input_files VALUES ('../AGENTS.md', '534795179005480511', 13259);
...
INSERT INTO input_files VALUES ('../design/FULL-COMPILATION-ASSESSMENT.0.md', '570293024811926396', 38328);
INSERT INTO input_files VALUES ('../design/FULL-COMPILATION-HANDOFF.0.md', '3894461313866455549', 628951);
INSERT INTO input_files VALUES ('../design/FULL-COMPILATION-REVIEW.0.md', '598721021469737951', 42534);
INSERT INTO input_files VALUES ('../design/FULL-COMPILATION.0.md', '5209217769278904146', 257680);
INSERT INTO input_files VALUES ('../design/FUNCTION-VALUE-SCOPE.0.md', '8338633968707983023', 71945);
INSERT INTO input_files VALUES ('../design/GO-TS-PARITY.0.md', '7708654490684213804', 23548);
INSERT INTO input_files VALUES ('../design/HANDLER-MIGRATION-LINE.0.md', '2789239841313563383', 5127);
...
INSERT INTO input_files VALUES ('../design/SESSION-HANDOVER.0.md', '8838059018719011198', 11648);
...
INSERT INTO input_files VALUES ('../design/legacy/FN-OUTPUT-SIG.0.ignore', '5680123931664569575', 11346);
INSERT INTO input_files VALUES ('../design/legacy/GO-MODULE-GRAPH.0.ignore', '1660294992940470352', 28818);
INSERT INTO input_files VALUES ('../design/legacy/HIGHER-ORDER-FUNCTIONS.0.ignore', '3451511449387220089', 88514);
INSERT INTO input_files VALUES ('../design/legacy/LANG-ENG-CONTENT-AUDIT.0.ignore', '6553854310083659527', 43036);
INSERT INTO input_files VALUES ('../design/legacy/O1-RELITIGATION.0.ignore', '490005561253846997', 11876);
INSERT INTO input_files VALUES ('../design/legacy/ROOT-MODULE-FEASIBILITY.0.ignore', '7261423727769978687', 6321);
INSERT INTO input_files VALUES ('../design/legacy/TS-PARITY-AUDIT.0.ignore', '2607459948929922084', 6455);
INSERT INTO input_files VALUES ('../design/legacy/TYPE-REPRESENTATION.0.ignore', '8325290123298438161', 11319);
INSERT INTO input_files VALUES ('../design/legacy/TYPE-REPRESENTATION.1.ignore', '8512126231640574787', 31258);
INSERT INTO input_files VALUES ('../design/legacy/checker-compiler-completeness-review.0.ignore', '5006798924669363812', 44251);
...
INSERT INTO sources VALUES ('src:audit', 'text', 'design/legacy/LANG-ENG-CONTENT-AUDIT.0.ignore', 'lang/eng content audit — ADR-012 evidence', NULL, 'audit-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
INSERT INTO sources VALUES ('src:basic-check-cut', 'text', 'design/legacy/BASIC-CHECK-CUT.0.ignore', 'removing basic''s dependency on check', NULL, 'basic-check-cut-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:completeness-review', 'text', 'design/legacy/checker-compiler-completeness-review.0.ignore', 'Type checker + bytecode compiler — completeness review', NULL, 'completeness-review-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:core-ts-coverage', 'text', 'design/legacy/CORE-TS-COVERAGE.0.ignore', 'core/ts coverage program', NULL, 'core-ts-coverage-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:fn-output-sig', 'text', 'design/legacy/FN-OUTPUT-SIG.0.ignore', 'fn output sig: the output slot is types, and only types', NULL, 'fn-output-sig-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:full-compilation-assessment', 'text', 'design/FULL-COMPILATION-ASSESSMENT.0.md', 'full compilation: progress assessment and forecast', NULL, 'full-compilation-assessment-2026-09-14', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:go-module-graph', 'text', 'design/legacy/GO-MODULE-GRAPH.0.ignore', 'Go module graph and per-module coverage, measured', NULL, 'go-module-graph-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:handler-migration-line', 'text', 'design/HANDLER-MIGRATION-LINE.0.md', 'the handler-migration line — a second session''s brief', NULL, 'handler-migration-line-2026-09-17', 'primary', '{
  "repository": "boru-lang/boru"
}');
INSERT INTO sources VALUES ('src:higher-order-functions', 'text', 'design/legacy/HIGHER-ORDER-FUNCTIONS.0.ignore', 'higher-order functions: an empirical capability audit', NULL, 'higher-order-functions-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO sources VALUES ('src:ts-parity-audit', 'text', 'design/legacy/TS-PARITY-AUDIT.0.ignore', 'parser twin parity audit', NULL, 'ts-parity-audit-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
INSERT INTO sources VALUES ('src:type-node-fusion', 'text', 'design/legacy/TYPE-REPRESENTATION.1.ignore', 'One object, one seam — the type-node fusion design', NULL, 'type-node-fusion-2026-08', 'primary', '{
  "repository": "boru-lang/boru"
}');
...
INSERT INTO entity_attributes VALUES ('ent:Document:2160474245302207298', 'role', 'the dated (2026-09-14) progress assessment and forecast for the full-compilation project, measured on main at c34a2fb (increment 59) rather than transcribed from the design''s status lines: it separates the two progress curves the project has — the corpus SAMPLE (frontier ledger 127 -> 29, interp-entry census 184 -> 28 in seventeen days) and the gate INVENTORY the mission is actually defined against (92 MarkUncompilable sites of 96, 114 undeclared handlers of 114, 5 defers of 5 across 17 vmDefer sites, 281 unattributed engine entries under a 505 ceiling never lowered, OpFallback and the drift window and BORU_COMPILE_FALLBACK all live, OpCollect and OpDispatchGeneric declared nowhere) — and reads the stage table against the tree (0-2 landed, 3 mostly, 4 half: twins flipped and the dispatch half unbuilt, 5 in narrow form, 6 started by rows, 7-9 not started). It classifies the remaining 29 ledger rows and 28 census rows by mechanism and reach (about 20 row-level, about 25 needing a Stage 5 or 7 slice, about 12 structural), gives calibrated probabilities per end state (corpus-native with rulings roughly 70% within a month and 90% by year end; T1 + T2 as written under 5% within a month, about 25% by year end, about 55% eventually; with an amended carve-out list 45% by year end), and sizes the remaining effort in session-days (18-33 to corpus-native with rulings, a further 65-115 to T1 + T2 with carve-outs, against about 20 spent). Its recommendations: rule O2, O4 and the attributed set in writing; build the generic lane''s first executing slice on the k pair next; stop taking rows whose fix is a Stage 5 or 7 slice as row-level increments; assign every refusal site a disposition in one census pass; fence the registry at the spawn seam; keep the one-in-seven negative-result rate; refresh this note at the end of each tier');
...
INSERT INTO entities VALUES ('ent:Document:4594023570607286819', 'Document', 'design/legacy/LANG-ENG-CONTENT-AUDIT.0.ignore', 'design/legacy/lang-eng-content-audit.0.ignore', 'accepted');
INSERT INTO entities VALUES ('ent:Document:4618181878588391523', 'Document', 'design/legacy/CORE-TS-COVERAGE.0.ignore', 'design/legacy/core-ts-coverage.0.ignore', 'accepted');
INSERT INTO entity_attributes VALUES ('ent:Document:4618181878588391523', 'role', 'the coverage program for core/ts (the sibling of ENG-COVERAGE-PARITY, one layer down): the staged work list, the ratcheting TS_CORE_GATE_LINES floor, and the measurement that core/spec is a cross-engine SPEC and not a coverage instrument');
...
INSERT INTO entities VALUES ('ent:Document:5687113773505447552', 'Document', 'design/HANDLER-MIGRATION-LINE.0.md', 'design/handler-migration-line.0.md', 'accepted');
INSERT INTO entity_attributes VALUES ('ent:Document:5687113773505447552', 'role', 'the brief for a second session that runs the handler-migration line (FULL-COMPILATION.0.md §6.8, Stage 6; the review''s §5 step S2) beside the compiler line: why it is the one track that does not contend for compiler/go and had no owner since its worklist was measured on 2026-08-25 (114 declaration-relevant signatures with no compile declaration, of 172 among 522 — code-body 59, quoted 44, fn-operand 11), what it accounts for (23 of the 113 corpus refusals, 14 raw-token code-body census rows, the eight boru:test quotation-body rows), where the worklist comes from (`make handler-worklist`, the declaration census''s listing), the per-word procedure (declaration versus rewrite by the reason, the corpus filter over the word''s rows, the gates in order, the ceiling lowered in the same change), what done looks like (the ceiling at 0, the code-body refusal buckets at 0, the RunResolved seam gone) and the rules the line inherits (generic lane first, never a token-returning handler, RunInterp as the oracle)');
INSERT INTO entities VALUES ('ent:Document:57595549560044982', 'Document', 'design/legacy/TYPE-REPRESENTATION.1.ignore', 'design/legacy/type-representation.1.ignore', 'accepted');
INSERT INTO entity_attributes VALUES ('ent:Document:57595549560044982', 'role', 'the follow-up design: fuse the minted node and the structural body into one object for named types (evaluation pushes the node; aliases adopt; structure recoverable FROM the node), one three-operation seam over every type value, Match+Unify as uniform node Behaviors, the five-stage migration plan, and the semantic deltas to pin — records NUR093 and NUR094');
INSERT INTO entities VALUES ('ent:Document:5774741150031044365', 'Document', 'design/legacy/checker-compiler-completeness-review.0.ignore', 'design/legacy/checker-compiler-completeness-review.0.ignore', 'accepted');
INSERT INTO entity_attributes VALUES ('ent:Document:5774741150031044365', 'role', 'the 2026-08 checker/compiler completeness review and its §9 implementation record — the living index of the HOF-compilation graduations and the remaining frontier work');
...
INSERT INTO entities VALUES ('ent:SoftwareModule:1512478893295979458', 'SoftwareModule', 'test/go/sentinelgate package', 'test/go/sentinelgate package', 'accepted');
INSERT INTO entity_attributes VALUES ('ent:SoftwareModule:1512478893295979458', 'go_module', 'github.com/boru-lang/boru/test/go');
INSERT INTO entity_attributes VALUES ('ent:SoftwareModule:1512478893295979458', 'parent_module', 'test/go');
INSERT INTO entity_attributes VALUES ('ent:SoftwareModule:1512478893295979458', 'path', 'test/go/sentinelgate');
INSERT INTO entity_attributes VALUES ('ent:SoftwareModule:1512478893295979458', 'unit', 'go-package');
...
INSERT INTO assertions VALUES ('ast:1029885292363430004', 'ent:Document:1661432640943029033', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
...
INSERT INTO assertions VALUES ('ast:131476052991904432', 'ent:Document:57595549560044982', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:131476052991904432', 'src:type-node-fusion', 'title', 'One object, one seam — the type-node fusion design', 'direct_record', 'kg-ingest');
INSERT INTO assertions VALUES ('ast:1335586659614579452', 'ent:Document:4594023570607286819', 'supports', 'entity', 'ent:SoftwareModule:425341189454841366', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:1335586659614579452', 'src:audit', '7A', 'the parser emits kernel STRUCTURAL MARKERS; the engine lowers each marker to word dispatches', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:1600691918237518265', 'ent:Document:2160474245302207298', 'related_to', 'entity', 'ent:Document:373024332343379636', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:1600691918237518265', 'src:full-compilation-assessment', 'Status', 'It answers two questions the running log does not: how likely the project is to reach the end state the directive names, and how much work is left', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:182716198357888821', 'ent:Document:7308074811740152317', 'supports', 'entity', 'ent:SoftwareModule:2013670336276694550', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:182716198357888821', 'src:type-representation-audit', '0. The three layers', 'The bug lives entirely in the third layer.', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:2188570018987729818', 'ent:Document:4594023570607286819', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.98, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:2188570018987729818', 'src:audit', 'title', 'Lang/Eng Content Audit — and the Types-Module Proposal', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:2298602473670200784', 'ent:Document:1015348168390754722', 'related_to', 'entity', 'ent:Document:2160474245302207298', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:2298602473670200784', 'src:full-compilation-review', 'Status', 'is the baseline this note re-measures three days later', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:2501882230840161821', 'ent:Document:2160474245302207298', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:2501882230840161821', 'src:full-compilation-assessment', 'title', 'Full compilation: progress assessment and forecast', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:2534747946469131495', 'ent:Document:5687113773505447552', 'related_to', 'entity', 'ent:Document:1015348168390754722', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:2534747946469131495', 'src:handler-migration-line', 'Status', 'from the velocity review (FULL-COMPILATION-REVIEW.0.md §3.4 and §5, step S2)', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:3936722462234910783', 'ent:Document:2160474245302207298', 'related_to', 'entity', 'ent:Document:6813571866310634100', NULL, NULL, NULL, NULL, 0.9, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:3936722462234910783', 'src:full-compilation-assessment', 'Status', 'the current-state page is SESSION-HANDOVER.0.md', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:4132647548202864129', 'ent:Document:4618181878588391523', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:4132647548202864129', 'src:core-ts-coverage', 'title', 'CORE-TS-COVERAGE.0 — taking core/ts from 62% to 100%', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:4297851351192324164', 'ent:Document:7308074811740152317', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:4297851351192324164', 'src:type-representation-audit', 'title', 'What a type name denotes — a representation audit', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:4842962168152383102', 'ent:Document:5687113773505447552', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:4842962168152383102', 'src:handler-migration-line', 'title', 'The handler-migration line — a second session''s brief', 'direct_record', 'kg-ingest');
...
INSERT INTO assertion_evidence VALUES ('ast:5232848138471645414', 'src:go-tree', 'test/go/sentinelgate', NULL, 'rule', 'kg-gomod');
...
INSERT INTO assertions VALUES ('ast:5611408655749975843', 'ent:Document:1661432640943029033', 'supports', 'entity', 'ent:SoftwareModule:6706536563979604982', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
...
INSERT INTO assertion_evidence VALUES ('ast:5796304702191188158', 'src:core-ts-coverage', 'The corpus is not the instrument', 'keep growing `core/spec` as a cross-engine spec, and stop treating it', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:5931205904113488781', 'ent:Document:6482726874773933255', 'supports', 'entity', 'ent:SoftwareModule:4559967244660037230', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:5931205904113488781', 'src:basic-check-cut', 'Status', '**Status:** COMPLETE (2026-08-08)', 'direct_record', 'kg-ingest');
INSERT INTO assertions VALUES ('ast:5990443274012573938', 'ent:Document:8514639994279285633', 'supports', 'entity', 'ent:SoftwareModule:2013670336276694550', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:5990443274012573938', 'src:root-module', 'The finding', '**The finding: `Value` alone closes over 75.7% of `core/go`.**', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:6160369784077875305', 'ent:Document:5774741150031044365', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:6160369784077875305', 'src:completeness-review', 'title', 'Type checker + bytecode compiler — completeness review', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:7030401685464928973', 'ent:Document:1015348168390754722', 'part_of', 'entity', 'ent:Document:520435226487613788', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
...
INSERT INTO assertion_evidence VALUES ('ast:7379487495924182141', 'src:compile-declaration-model', 'title', 'The compile declaration model', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:7593629403768385449', 'ent:Document:4472215996454426427', 'related_to', 'entity', 'ent:Product:2046405728378673079', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:7593629403768385449', 'src:go-module-graph', 'Status', 'the same ground truth `kg/gomod.boru` reads to build the knowledge graph''s module view', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:776075804249928365', 'ent:Document:1015348168390754722', 'related_to', 'entity', 'ent:Document:373024332343379636', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:776075804249928365', 'src:full-compilation-review', 'Status', 'The staging correction is also written into the design itself as §10''s dated amendment, so the design stays the authority on what is planned.', 'direct_record', 'kg-ingest');
...
INSERT INTO assertions VALUES ('ast:7871378183277618507', 'ent:Document:57595549560044982', 'supports', 'entity', 'ent:SoftwareModule:2013670336276694550', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-08-07T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:7871378183277618507', 'src:type-node-fusion', '3. The design', 'The design: a type IS its node, and the node carries its content', 'direct_record', 'kg-ingest');
