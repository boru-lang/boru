...
- `force-arity` container · paren-group — **declined** — fn-value application bounded by a paren (dynamic value precedes args)
...
- `force-arity` container · module-body — **declined** — fn-value application bounded by a paren (dynamic value precedes args)
...
- `forward-args` container · paren-group — **declined** — fn-value application bounded by a paren (dynamic value precedes args)
...
- `forward-args` container · module-body — **declined** — fn-value application bounded by a paren (dynamic value precedes args)
...
- `parse` named-fn · prefix-stack — **declined** — residual shape beyond Stage 1 (call result above a literal)
...
- `parse` module-export · prefix-stack — **declined** — residual shape beyond Stage 1 (call result above a literal)
...
- `usurp` container · paren-group — **declined** — fn-value application bounded by a paren (dynamic value precedes args)
...
- `usurp` container · module-body — **declined** — fn-value application bounded by a paren (dynamic value precedes args)
