...
| engine entries | 422 | 0 | 422 | open | unattributed interpreter runs on the compiled path, by seam: Engine.Run×422, CallBoru×244, RunResolved×112, runPooledSub×26, vm:island×11, vm:island-resolved×9, InvokeCallback:callboru×8 |
