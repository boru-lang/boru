...
| compile failures | 13 | 0 | 13 | open | corpus rows that FAIL to compile — every one a BUG, not a policy (design/COMPILABLE-SUBSET.md §5); the sum of compile_failures.tsv |
| compute gaps | 8 | 0 | 8 | open | real-compute rows that fail to compile |
