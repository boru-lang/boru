...
| engine entries | 281 | 0 | 281 | open | unattributed interpreter runs on the compiled path, by seam: Engine.Run×281, CallBoru×235, RunResolved×14, runPooledSub×9, vm:island-resolved×7, InvokeCallback:callboru×5, vm:island×4 |
