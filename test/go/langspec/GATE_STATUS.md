...
| compute gaps | 104 | 0 | 107 | open | real-compute rows that refuse |
...
| engine entries | 366 | 0 | 379 | open | unattributed interpreter runs on the compiled path, by seam: Engine.Run×366, CallBoru×250, RunResolved×40, runPooledSub×26, vm:island×21, InvokeCallback:callboru×10, vm:island-resolved×9 |
...
| interpreter islands | 10 | 0 | 12 | open | compiled programs with an OpFallback span — an uncompiled region inside something called compiled |
