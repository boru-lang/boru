...
1. **S1b's apply shapes, the remainder** — the first slice landed on
   ...
   container reads inside quotation bodies (each-variants L205,
...
| `lang/go/compile_defect_test.go` | unit-test programs: do not compile / compile then bail | 280 / 34 |
